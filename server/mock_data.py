...
# Load restock orders. Unlike every other dataset this one is written to at
# runtime (POST /api/restock-orders appends to it), so it starts out empty and
# its contents do not survive a server restart.
