    ...
    <div v-else>
      ...
      <div class="stats-grid-finance">
        ...
        <div class="stat-card profit-card">
          ...
          <div class="stat-meta"><span class="num">{{ profitMargin }}%</span> {{ t('finance.margin') }}</div>
        </div>
        <div class="stat-card">
      ...
      <div class="card chart-card">
        ...
        <div class="chart-container">
          <div class="bar-chart">
            <div class="y-axis">
              <span class="num">{{ currencySymbol }}{{ maxRevenueValue }}K</span>
              <span class="num">{{ currencySymbol }}{{ Math.round(maxRevenueValue * 0.75) }}K</span>
              <span class="num">{{ currencySymbol }}{{ Math.round(maxRevenueValue * 0.5) }}K</span>
              <span class="num">{{ currencySymbol }}{{ Math.round(maxRevenueValue * 0.25) }}K</span>
              <span class="num">{{ currencySymbol }}0</span>
            </div>
      ...
      <div class="card chart-card">
        ...
        <div class="chart-container">
          <div class="bar-chart">
            <div class="y-axis">
              <span class="num">{{ currencySymbol }}25K</span>
              <span class="num">{{ currencySymbol }}20K</span>
              <span class="num">{{ currencySymbol }}15K</span>
              <span class="num">{{ currencySymbol }}10K</span>
              <span class="num">{{ currencySymbol }}5K</span>
              <span class="num">{{ currencySymbol }}0</span>
            </div>
            <div class="chart-area">
          ...
          <div class="category-list">
            <div v-for="category in categorySpending" :key="category.category" class="category-item">
              ...
              <div class="category-meta">
                <span class="percentage"><span class="num">{{ category.percentage }}%</span> {{ t('finance.categorySpending.ofTotal') }}</span>
          ...
          <div class="transactions-table-container">
            <table class="transactions-table">
              ...
              <tbody>
                ...
                >
                  <td class="transaction-id num">{{ transaction.id.toString().padStart(3, '0') }}</td>
                  <td class="transaction-description">{{ transaction.description }}</td>
                  <td class="transaction-vendor">{{ transaction.vendor }}</td>
                  <td class="transaction-date num">{{ formatDateShort(transaction.date) }}</td>
                  <td class="transaction-amount text-right num">{{ currencySymbol }}{{ transaction.amount.toLocaleString() }}</td>
                </tr>
              </tbody>
            </table>
          </div>
...
/* Chart-series palette: qualitative categorical colors with no token equivalent */
